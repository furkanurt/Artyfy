<template>
  <div>
    <v-container v-if="!appStore.isMobile">
      <v-card
        v-show="fetchResultPost"
        v-for="(post, i) in fetchResultPost"
        :key="i"
          ...
          <div class="flex justify-between">
            ...
            <div>
              <v-tooltip location="top">
                ...
                <span v-if="post.isOnSale">{{ $t('postCard.onSale') }}</span>
      ...
      <v-card
        v-show="fetchMarketResultPost"
        v-for="(post, i) in fetchMarketResultPost"
        :key="i"
        class="mx-auto mb-5 w-full"
        variant="flat"
      >
